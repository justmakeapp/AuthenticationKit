...
public enum L10n {
  ...
  public enum Action {
    ...
    /// Register with email
    public static let registerWithEmail = L10n.tr("AuthKit", "action.registerWithEmail", fallback: "Register with email")
    /// Reset password
  ...
  public enum Error {
    ...
    public static func passwordMustHaveAtLeast(_ p1: Int) -> String {
      return L10n.tr("AuthKit", "error.passwordMustHaveAtLeast", p1, fallback: "Password must have at least %d characters.")
    }
  }
  public enum Message {
    /// Open %@ and sign in to share.
    public static func appExtensionRequireAuth(_ p1: Any) -> String {
      return L10n.tr("AuthKit", "message.appExtensionRequireAuth", String(describing: p1), fallback: "Open %@ and sign in to share.")
    }
    /// Please check your email for the verification link
    public static let checkMailForLink = L10n.tr("AuthKit", "message.checkMailForLink", fallback: "Please check your email for the verification link")
    /// The password reset was successfully sent
    public static let passwordResetLinkWasSent = L10n.tr("AuthKit", "message.passwordResetLinkWasSent", fallback: "The password reset was successfully sent")
  }
  public enum SignIn {
    /// Don't have an account?
    public static let dontHaveAnAccount = L10n.tr("AuthKit", "signIn.dontHaveAnAccount", fallback: "Don't have an account?")
    /// Forgot your password?
    public static let forgotYourPassword = L10n.tr("AuthKit", "signIn.forgotYourPassword", fallback: "Forgot your password?")
    /// Welcome to %@
  ...
  public enum SignUp {
    ...
    public static let bySelectingSignUpBelowIAgreeTo = L10n.tr("AuthKit", "signUp.bySelectingSignUpBelowIAgreeTo", fallback: "By selecting Sign Up below, I agree to ")
  }
}
