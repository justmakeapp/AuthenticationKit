...
enum Asset {
    static let appleIcon = ImageAsset(name: "AppleIcon")
    static let googleColor = ColorAsset(name: "GoogleColor")
    static let googleFavicon = ImageAsset(name: "GoogleFavicon")
}
